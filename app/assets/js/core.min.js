...
function widthFunctions(e) {
    ...
    if (s < 992 && $("#widgets-area").is(":visible") == 1) {
        $("#widgets-area-button").removeClass("close").addClass("open");
        var o = $("#content").attr("class"), u = parseInt(o.replace(/^\D+/g, "")), a = u + 2, f = "col-sm-" + a;
        $("#widgets-area").hide();
        $("#content").removeClass("col-sm-" + u);
        $("#content").addClass(f)
    }
    if (s > 767) {
        t > n ? $("#content").css("min-height", t) : $("#content").css("min-height", "auto");
        $(".dark").css("height", r)
    } else $(".dark").css("height", "auto")
}
...
jQuery(document).ready(function (e) {
    ...
    e("#main-menu-toggle").click(function () {
        if (e(this).hasClass("open")) {
            ...
            var t = e("#content").attr("class"), n = parseInt(t.replace(/^\D+/g, "")), r = n + 1, i = "col-sm-" + r;
            e("#content").removeClass("col-sm-" + n);
            e("#content").addClass(i);
            e("#content").addClass("full-radius");
            e("#sidebar-left").hide()
        } else {
            e(this).removeClass("close").addClass("open");
            var t = e("#content").attr("class"), n = parseInt(t.replace(/^\D+/g, "")), r = n - 1, i = "col-sm-" + r;
            e("#sidebar-left").fadeIn();
            e("#content").removeClass("col-sm-" + n);
            e("#content").removeClass("full-radius");
            e("#content").addClass(i)
        }
    })
});
jQuery(document).ready(function (e) {
    var t = !0;
    e("#widgets-area-button").click(function () {
        if (e(this).hasClass("open")) {
            e(this).removeClass("open").addClass("close");
            var n = e("#content").attr("class"), r = parseInt(n.replace(/^\D+/g, "")), i = r - 2, s = "col-sm-" + i;
            e("#content").removeClass("col-sm-" + r);
            e("#content").addClass(s);
            e("#widgets-area").fadeIn();
            if (t) {
            ...
            e(this).removeClass("close").addClass("open");
            var n = e("#content").attr("class"), r = parseInt(n.replace(/^\D+/g, "")), i = r + 2, s = "col-sm-" + i;
            e("#widgets-area").fadeOut();
            e("#content").removeClass("col-sm-" + r);
            e("#content").addClass(s)
        }
    });
    e("#close-widgets-area").click(function () {
        var t = e("#content").attr("class"), n = parseInt(t.replace(/^\D+/g, "")), r = n + 2, i = "col-sm-" + r;
        e("#widgets-area").fadeOut();
        e("#content").removeClass("col-sm-" + n);
        e("#content").addClass(i);
        e("#widgets-area-button").hasClass("open") ? e("#widgets-area-button").removeClass("open").addClass("close") : e("#widgets-area-button").removeClass("close").addClass("open")
    })
});
jQuery(document).ready(function (e) {
    if (e(".todo-remove").length) {
        e(".todo-remove").click(function () {
            e(this).parent().parent().fadeTo("slow", 0, function () {
                e(this).slideUp("slow", function () {
                    e(this).remove()
                })
            });
        ...
        e(function () {
            e(".todo-remove").parent().parent().parent().sortable();
            e(".todo-remove").parent().parent().parent().disableSelection()
        })
    }
});
